...
Funktionstestene kontrollerer at vores program producerer de forventede uddata ud fra specificeret inddata. Funktionstestene er til for at teste nogle af de centrale dele i vores program. Alle funktionstest og deres resultater kan ses i bilag ''Test specifikation'' på side \pageref{bilag:testspec}.
